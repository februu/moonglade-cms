...
<body class="h-screen bg-zinc-950 text-zinc-100 flex flex-col items-center justify-center">
    <div class="w-full max-w-sm p-6 bg-zinc-900 rounded-lg shadow-md">
        ...
        <form action="/mg-admin/login.php" method="POST" class="flex flex-col gap-4">
            <input type="text" name="username" placeholder="Username" required class="p-2 bg-zinc-800 border border-zinc-700 rounded-md">
            <input type="password" name="password" placeholder="Password" required class="p-2 bg-zinc-800 border border-zinc-700 rounded-md">
